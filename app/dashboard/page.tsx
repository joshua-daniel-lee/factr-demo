  ...
  return (
    <AppShell title="Dashboard">
      <div className="p-6 md:p-8 space-y-8">
        {/* Welcome Section */}
        <div className="bg-gradient-to-r from-bunting via-primary via-gray-300 to-white rounded-2xl p-8 text-white relative overflow-hidden h-[160px] flex items-center">
